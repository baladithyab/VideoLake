# =============================================================================
# pgvector Aurora Serverless v2 - Variables
# =============================================================================
...
variable "instance_count" {
  description = "Number of Aurora Serverless v2 instances (1 for single-AZ, 2+ for multi-AZ HA)"
  type        = number
  default     = 1
...
variable "vpc_id" {
  description = "VPC ID for the Aurora Serverless v2 cluster"
  type        = string
}

variable "private_subnet_ids" {
  description = "List of private subnet IDs for the Aurora Serverless v2 cluster"
  type        = list(string)
