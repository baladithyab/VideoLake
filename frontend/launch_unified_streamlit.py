...
def main():
    ...
    print("=" * 80)
    print("🎬 S3Vector Unified Streamlit Demo")
    print("=" * 80)
    print()
    print("🚀 Launching comprehensive video search pipeline demo...")
    print()
    print("📋 Features included:")
    print("   • Index Setup & Management")
    print("   • Video Ingestion (TwelveLabs + S3 Vector)")
    print("   • Multi-Modal Search (Text ↔ Video)")
    ...
    print()
    print("💡 Tip: Use the sidebar to navigate between features")
