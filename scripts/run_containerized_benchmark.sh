...
QDRANT_EBS_IP="44.201.32.17"
QDRANT_EFS_IP="13.220.215.190"
LANCEDB_EBS_IP="98.82.24.196"
LANCEDB_EFS_IP="54.166.202.132"
LANCEDB_S3_IP="100.25.34.180"
...
echo "  CloudWatch Logs: /ecs/s3vector-benchmark-runner"
echo "  Results will be uploaded to: s3://$S3_BUCKET/$S3_RESULTS_PREFIX/$SESSION_NAME/"
echo ""
echo "To view logs:"
echo "  aws logs tail /ecs/s3vector-benchmark-runner --follow --region $AWS_REGION"
echo ""
