...
class BulkVideoProcessor:
    ...
    def generate_report(self) -> str:
        ...
        fastest = self.metrics.fastest_video_sec if self.metrics.fastest_video_sec else 0
        slowest = self.metrics.slowest_video_sec if self.metrics.slowest_video_sec else 0
        report.append(f"| Fastest Video | {fastest:.2f}s |\n")
        report.append(f"| Slowest Video | {slowest:.2f}s |\n\n")
